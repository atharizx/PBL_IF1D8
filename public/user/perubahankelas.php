...
<body>
    ...
    <section id="beranda" class="active">
      ...
      <section id="pengumuman-terbaru">
        <div class="container mt-5">
          <h2 class="text-center mb-3 fw-semibold">INFORMASI PERUBAHAN KELAS TERBARU</h2>
          ...
          <div class="row" id="cardContainer">
            <?php
            userCardRender($conn, "perubahankelas", $filter = ['tanggal' => $tanggal]);
            ?>
          </div>
  ...
  <div class="modal fade" id="filterModal" tabindex="-1" aria-labelledby="filterModalLabel" aria-hidden="true">
    <div class="modal-dialog modal-dialog-centered">
      <div class="modal-content">
        <form method="GET" action="perubahankelas.php">
  ...
  <script src="../style/filterhandler.js"></script>
