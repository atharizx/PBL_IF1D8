...
// Function Untuk Merender Semua Jenis Tipe Informsi pada page index.php
function renderAllCard($conn, $filter = [])
{
    // Variable Awal
    $whereJadwal = "1=1";
    $wherebeasiswa = "1=1";
    ...
    // Mengambil data dari database sesuai tipe informasi dan filter
    $importDataJadwal = takeData($conn, "jadwalujian", "*", $whereJadwal);
    $importDataBeasiswa = takeData($conn, "beasiswa", "*", $wherebeasiswa);
    $importDataKelas = takeData($conn, "perubahankelas", "*", $whereKelas);

    // Menyatukan beberapa data menjadi satu format
    ...
    // Menyorting sesuai tanggal penebritan terbaru
            ...
            <div class='modal-dialog modal-lg modal-dialog-centered'>
                <div class='modal-content'>
                    ...
                    <div class='modal-header bg-primary'>
                        <h4 class='fw-bold mb-0 text-white'>Detail Informasi</h4>
